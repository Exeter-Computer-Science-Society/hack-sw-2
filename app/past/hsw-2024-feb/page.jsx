    ...
    <div className="bg-HSWprimary w-full h-fit">
      ...
      <div className="flex flex-col items-center justify-center w-full h-fit px-[5%]">
        ...
        <div className="w-full h-full p-2 grid grid-flow-column grid-cols-4 gap-2 ">
          ...
          />
          <Image
            src="/images/organisers.JPEG"
            className=" rounded-2xl w-full h-full object-cover col-span-2"
            width={500}
            height={500}
            alt="not found"
          />
          ...
          <Link
            ...
            className="h-full w-full rounded-2xl bg-HSWprimary border border-HSWaccent hover:border-HSWtext flex flex-col justify-center items-center"
            target="_blank"
          >
      ...
      <div className="flex items-center gap-2 justify-center w-full h-fit px-[5%] py-[5%]">
        ...
        <Link href={"https://excs.uk"} target="_blank">
          <Image
            src="/excs.svg"
            className="self-center rounded-2xl w-fit h-16 object-contain select-none"
            width={500}
            height={500}
            alt="not found"
          />
