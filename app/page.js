  ...
  const questions = [
    {
      ...
      answer:
        "Absolutely! Hack South West is a great opportunity to learn new skills, meet new people, and have fun. Whether you're a beginner or an experienced hacker, there's something for everyone at Hack South West.",
    },
    {
      question: "What is a hackathon?",
      answer:
        "A hackathon is an event where people come together to work on a project for a set amount of time. It is a great opportunity to learn new skills, meet new people, and have fun!",
    },
    {
      question: "Who can attend?",
      answer:
        "We welcome everyone, weather your a student here or external university or working in industry, we welcome everyone to come and join us for a weekend of fun and learning.",
    },
    {
      question: "Where is Hack South West Happening?",
      answer:
        "We are hosting the event in the innovation centre at the University of Exeter. The address is: University of Exeter, Innovation Centre, Rennes Drive, Exeter, EX4 4RN",
    },
    {
      question: "What will be available to eat?",
      answer:
        "We will be providing all hackers with food and drinks throughout the event. Dietary requirement will be catered for as well so no need to worry!",
    },
    {
      question: "Do I need to be able to code to attend?",
      answer:
        "Not at all! Hack South West is open to everyone, regardless of your coding experience. We will have workshops and mentors available to help you get started with your project.",
    },
    {
      question: "How large can my team be?",
      answer:
        "We enforce team sizes of no more than 4 people. This is to ensure that everyone has a fair chance of winning the competition.",
    },
    {
      question: "What should I bring?",
      answer:
        "You should bring your laptop, charger, and any additional items to make your stay comfortable. We will provide you with seating, power, food, and a lovely atmosphere.",
    },
    {
      question: "Do we have a code of conduct?",
      answer:
        "Yes, we have a code of conduct that all attendees must adhere to. This is to ensure that everyone has a safe and enjoyable experience at Hack South West.",
    },
    {
    ...
    <div className="w-full h-fit">
      ...
      <div className="relative flex flex-col items-center justify-center w-full h-[100vh] px-[15%] max-lg:px-[5%] pt-[10%] max-lg:pt-[40%] z-50">
        ...
        <div className="flex flex-col gap-8 w-full h-full">
          ...
          <div className="text-wrap w-full">
            <p className="text-xl max-lg:text-xs font-mono">
              The largest Hackathon in the South West
            </p>
            <p className="flex gap-2 max-lg:text-xs font-bold">
          ...
          <div className="flex gap-4 max-lg:flex-col">
            ...
            >
              <p className="text-2xl max-lg:text-sm font-extrabold">
                Learn More
              </p>
            </button>
      ...
      >
        ...
        <div className="flex flex-col gap-16 max-lg:gap-8 w-fit">
          <div>
            <h1 className="text-6xl md:text-5xl sm:text-3xl font-bold text-HSWaccent">
              About Us
            </h1>
          </div>
          ...
          <div className="flex flex-col gap-2 justify-center items-center w-full font-light">
            <p className="max-lg:rounded-xs">
              Organised by the Computer Science Society (EXCS) and Cyber
              Security Society (CyberSoc) of University Of Exeter, Hack South
              West is the most fun and enjoyable experience for students around
              the UK. Available to everyone from beginners to experts, this is a
              great opportunity to get into hackathons. Our welcoming atmosphere
              will surely encourage you to go to more!
            </p>
            <p className="max-lg:rounded-xs">
              We will run two events this year! Firstly in November there will
              be a Capture The Flag (CTF) competition, followed by the main
              hackathon event in February. The CTF will be a great way for
              anyone to get involved with problem solving and cybersecurity
              challenges, while the main hackathon will allow participants to
              build projects, learn new skills, and network with like-minded
              individuals. Both events include exceptional prizes and plenty of
              food to keep you going! To find out more about either event visit
              our registration website which you may find on this part of the
              website and also at the top!
            </p>
          </div>
          ...
          >
            ...
            <p className="text-2xl max-lg:text-sm font-semibold text-nowrap">
        ...
        <div className="flex justify-around gap-16 max-lg:gap-8 w-full h-fit px-[15%] pt-32 pb-16 max-lg:px-[5%] bg-HSWsecondary2">
          <div className="w-full">
            ...
            <p className="text-md font-extralight">
              What will you be doing during our events! Here you can find out
              more about both of our events!
            </p>
          </div>
            ...
            <div className="w-full h-fit flex max-md:flex-col justify-center items-center gap-16">
              ...
              <div className="relative w-full h-full flex flex-col items-center gap-8 py-8 self-start">
                <p className="text-3xl font-thin text-HSWtext pb-80">
                  <b className="text-HSWaccent font-extrabold">
                    Capture The Flag
                  </b>{" "}
                  Event
                </p>
                ...
                <p className="px-[10%] z-50">
                  ...
                  <b className="text-HSWaccent">
                    12-hour Capture the Flag Hackathon
                  </b>{" "}
                  on <b>Friday, 8th November</b>, hosted at the{" "}
                  <b>Innovation Centre, Phase 2</b>. In this track, your
                  cybersecurity knowledge will be pushed to the limit! With
                  three exciting difficulties and <b>30 unique boxes</b> to
                  solve, there’s something for everyone. Every completed
                  challenge will grant you a flag to unlock points at{" "}
                  <b className="text-HSWaccent">any moment</b> during the
                  hackathon. Explore hidden Easter eggs around the venue, meet
                  our sponsors, and enjoy a full day of hacking, learning, and
                  collaboration.
                </p>

                {/* Schedule */}
                <div className="px-[10%] w-full max-w-3xl">
                  <p className="text-2xl font-semibold text-HSWaccent mt-4 mb-6 text-center">
                    🕗 Schedule
                  </p>
                  ...
                  <div className="relative border-l-2 border-HSWaccent ml-4">
                    ...
                    <div className="mb-6 ml-6 relative">
                      ...
                      <p className="font-semibold text-lg text-HSWtext">
                        8:00 AM
                      </p>
                      <p className="text-sm text-HSWtext/80">
                ...
                <div className="px-[10%] text-left w-full max-w-3xl">
                  <p className="text-2xl font-semibold text-gold mt-6 mb-2">
                    🏆 Prizes
                  </p>
              ...
              <div className="relative w-full h-full flex flex-col items-center gap-8 py-8 self-start">
                ...
                <p className="px-[10%]">
                  This event will push you to develop your own creative solution
                  to a challenge faced by the world. We look out for solutions
                  that incorporate a high level of technical knowledge to a
                  problem of significant{" "}
                  <b className="text-HSWaccent">impact</b> in the world.
                  Although, you will likely only work on this problem for a
                  limited amount of time, we encourage you to continue to
                  develop and deploy your solutions to either the web or other
                  sources to both add to your portfolio, but also benefit
                  humanity!
                </p>

                <p className="px-[10%]">
                  We are still working hard on organising this, please check out
                  our socials for more information as it comes! <br />
                </p>
      ...
      <div id="qa" className="flex flex-col">
        <div className="flex justify-around gap-16 max-lg:gap-8 w-full h-fit px-[15%] pt-32 pb-16 max-lg:px-[5%] bg-HSWsecondary2">
          <div className="w-full">
            <p className="text-6xl md:text-5xl sm:text-3xl font-bold text-HSWaccent">
              Questions &
            </p>
            <p className="text-6xl md:text-5xl sm:text-3xl font-bold text-HSWaccent">
              Answers
            ...
            <br />
            <p className="text-md font-extralight">
              Have questions? Here you&apos;ll find all the answers to your
              questions. If there is something missing feel free to reach out to
              us with absolutely any queries via our email.
            </p>
          </div>
        ...
        <div className="bg-HSWprimary w-full h-fit flex gap-16 max-lg:gap-8 px-[15%] pt-32 pb-16 max-lg:px-[5%]">
          <div className="w-2/5 h-full flex flex-col gap-2 justify-center items-start max-lg:hidden">
            <Link href={"/"} className="font-light underline text-HSWaccent">
