...
const info = {
  liminal: {
    ...
    description:
      "Liminal is a cybersecurity platform designed to help regulated enterprises securely adopt generative AI technologies.",
  ...
  dora: {
    ...
    description:
      "DoraHacks is a global hackathon organization that aims to foster innovation and creativity in the tech community.",
  ...
  exeter: {
    ...
    description:
      "The University of Exeter is a UK-based university",
  ...
  excs: {
    ...
    description:
      "The Exeter Computer Science Society supports computer science students through hackathons, workshops, and social events",
    site: "https://www.excs.uk/",
    linkedin:
      "https://www.linkedin.com/school/exeter-computing-society/",
  },
  mintsw: {
    name: "Mint South West",
    image: "/images/sponsors/mintswdark.png",
    description:
      "Mint South West supports the crypto community in the South West",
  ...
  techexeter: {
    ...
    description:
      "Tech Exeter is a community of tech enthusiasts hosting regular meetups, workshops, and conferences",
  ...
  hh: {
    ...
    description:
      "HackingHub is a cutting-edge platform for web application hacking education",
  ...
  pydata: {
    ...
    description:
      "PyData Exeter hosts talks and community events",
  ...
  cybersoc: {
    ...
    description:
      "The Exeter CyberSecurity Society is building a vibrant cyber community at the University of Exeter",
    site: "https://my.exeterguild.com/groups/TT2W9/cyber-security-society",
    linkedin:
      "https://www.linkedin.com/company/exeter-cyber-security-society/",
  },
  secridge: {
    name: "Sec Ridge",
    image: "/images/sponsors/secridgeblack.png",
    description:
      "Sec Ridge empowers the next generation of cybersecurity professionals",
    site: "https://www.sec-ridge.com/",
    linkedin: "https://www.linkedin.com/company/secridge/",
  },
  superteam: {
    name: "SuperTeam",
    image: "/images/sponsors/superteam.png",
    description:
      "SuperTeam helps the most promising projects in the Solana ecosystem",
  ...
  solana: {
    ...
    description:
      "The Solana Foundation supports the decentralization, growth, and security of the Solana network",
